...
def timestamp_geo_parser(root_folder, ison_folder, ison_exe):
    ...
    print(f"ISON data folder: {ison_data_folder}")
    print(f"App executable: {app_exe}")
    ...
    for file in os.listdir(raw_folder):
        ...
        try:
            with zipfile.ZipFile(zip_path, 'r') as zip_ref:
                ...
                #print("Calling the GUI application...")
...
if __name__ == "__main__":
    ...
    import sys
    root_folder = sys.argv[1] if len(sys.argv) > 1 else os.getcwd() #r"C:\DimDev\DataTools\Read_BIN"
